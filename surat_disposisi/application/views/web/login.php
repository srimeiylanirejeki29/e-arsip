  	...
  	<div class="col-md-12">
  		<div class="navbar-header">
  			<ul class="nav navbar-nav navbar-center">
  				<li><a href="javascript:void(0)"><span class='glyphicon glyphicon-send' aria-hidden='true'></span>&nbsp;<b> SISTEM INFORMASI SURAT</b></a></li>
  			</ul>
  		</div>
  	</div>
  </nav>
  	...
  	<div class="kotak">
  		...
  		<div class="wrapper">
  			<p style="padding: 20px 10px; text-align-last: center;">
  				<img src="<?php echo base_url('foto/logobonet.png') ?>" height="100">
  			</p>
  			<div class="title1"><span>LOGIN SIS ADMINISTRASI</span></div>
