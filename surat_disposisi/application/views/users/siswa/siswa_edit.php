                            ...
                            <form class="form-horizontal" action="" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nim" id="nim" value="<?php echo $query->nim; ?>" class="form-control" placeholder="Masukkan Nomor Induk Madrasah (NIM)" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nisn" id="nisn" value="<?php echo $query->nisn; ?>" class="form-control" placeholder="Masukkan Nomor Induk Sekolah Nasional (NISN)" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nm_siswa" id="nm_siswa" value="<?php echo $query->nm_siswa; ?>" class="form-control" placeholder="Masukkan Nama Lengap" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="ttl" id="ttl" value="<?php echo $query->ttl; ?>" class="form-control" placeholder="Contoh: Situbondo, 10 Januari 1991" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-list"></i></span>
                                            <input type="text" name="nm_ort" id="nm_ort" value="<?php echo $query->nm_ort; ?>" class="form-control" placeholder="Masukkan Nama Orang Tua" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-spinner"></i></span>
                                            <textarea type="text" name="alamat" id="alamat" class="form-control" placeholder="Masukkan Alamat Lengkap" required><?php echo $query->alamat; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
