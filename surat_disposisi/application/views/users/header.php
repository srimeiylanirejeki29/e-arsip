...
<head>
	...
	<link rel="icon" type="image/png" href="foto/logobonet.png">
	...
	<!-- /core JS files -->
	<?php
	if ($sub_menu == "" or $sub_menu == "profile" or $sub_menu == "lap_sk" or $sub_menu == "lap_sm" or $sub_menu == "lap_diklat") { ?>
		<!-- Theme JS files -->
	...
	<?php
	if ($sub_menu == "control" or $sub_menu == "kepala" or $sub_menu == "ktu" or $sub_menu == "pengguna" or $sub_menu == "bagian" or $sub_menu == "md" or $sub_menu == "siswa" or $sub_menu == "sm" or $sub_menu == "sk" or $sub_menu == "diklat" or $sub_menu == "data_sm" or $sub_menu == "data_sk" or $sub_menu == "data_diklat" or $sub_menu == "ska") { ?>
		<!-- Theme JS files -->
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href="" style="color: #FFF;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span><b>&nbsp;&nbsp;SIS ADMINISTRASI</b></a>
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<?php if ($user->row()->level != 'ktu' and $user->row()->level != 'kepala') { ?>
										...
										<ul>
											...
											if ($user->row()->level != 'user') { ?>
												<li class="<?php if ($sub_menu == "bagian") {
																echo 'active';
															} ?>"><a href="users/bagian"><i class="icon-stack2"></i> <b>DATA KARYAWAN</b></a>
												</li>
											<?php } ?>
											...
											<li class="<?php if ($sub_menu == "md") {
															echo 'active';
														} ?>"><a href="users/md"><i class="icon-certificate"></i> <b>PROFIL COMPANY</b></a>
											</li>
										</ul>
									</li>
									...
									if ($user->row()->level != 'user') { ?>
										...
										<li><a href="users/diklat"><i class="icon-file-stats2"></i> <span><b>DIKLAT</b></span></a></li>
										<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm") {
											...
											<ul>
												...
												<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "data_sk") {
																echo 'active';
															} ?>"><a href="users/lap_sk"><i class="icon-file-empty"></i> <b>SURAT KELUAR</b></a></li>
												<li class="<?php if ($sub_menu == "lap_diklat" or $sub_menu == "data_diklat") {
																echo 'active';
															} ?>"><a href="users/lap_diklat"><i class="icon-file-text"></i> <b>DIKLAT</b></a></li>
											</ul>
										</li>
									<?php } ?>
								<?php } ?>
